package com.ifm.devsam.springsec.security.config;

import com.ifm.devsam.springsec.security.filter.JwtAuthenticationCookieFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5500")); // Add your front-end URL here
